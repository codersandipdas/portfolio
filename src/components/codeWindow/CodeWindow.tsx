...
export const CodeWindow = () => {
  ...
  return (
    <div className='relative w-full h-full overflow-hidden rounded-xl border-2 bg-gray-900 md:bg-white/5 p-2.5 shadow-2xl drop-shadow-lg border-gray-600/40 backdrop-blur-xl'>
